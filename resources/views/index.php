        ...
        <div class="container">
            ...
            <header id="header">
                <div class="inner">
                    ...
                    <!-- Logo -->
                    <h1><a href="index_.html" id="logo">ZeroFour</a></h1>

                    <!-- Nav -->
                    <nav id="nav">
                        <ul>
                            <li class="current_page_item"><a href="index_.html">Home</a></li>
                            <li>
                                <a href="#">Dropdown</a>
                                <ul>
...
<!--        <link href="css/app.css" rel="stylesheet" type="text/css">-->
<!--    --><?// }else{ ?>
<!--        <link href="css/m.app.css" rel="stylesheet" type="text/css">-->
<!--    --><?// } ?>
...
<!--<body>-->
<!---->
<!--<div class="glass_bg"></div>-->
<?// include 'nav.php'?>
<!---->
<?// include "$device/$page.php"?>
<!---->
<?// include "$device/footer.php" ?>
<!---->
<!---->
